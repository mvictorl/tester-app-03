  ...
  return (
    ...
    >
      <Card style={ { width: 600 } } className="p-5">
        ...
        <Form noValidate onSubmit={ e => submitRegOrAuth(e) } className="d-flex flex-column">
          { !isLoginPage && (
            <Form.Group controlId="formUsername" className="my-3">
              ...
              <Form.Control
                ...
                // isValid={errUsername}
              />
              <Form.Control.Feedback type="invalid">{ errUsername }</Form.Control.Feedback>
            </Form.Group>
          ) }
          ...
          { !isLoginPage && (
            <Form.Group controlId="formConfirm" className="mt-3">
              ...
              />
              <Form.Control.Feedback type="invalid">{ errConfirm }</Form.Control.Feedback>
            </Form.Group>
          ) }
